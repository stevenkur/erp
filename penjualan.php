              ...
              for($i=0; $i<sizeof($hasil); $i++)
              {
                echo '
                  <tr>
                    ...
                    <td><a class="btn btn-success" type="submit" href="<?php echo 'barangpenjualan.php?namabarang='.$hasil[$i]['namabarang'].'&jumlahbarang='.$hasil[$i]['jumlahbarang'].'&hargabarang='.$hasil[$i]['hargabarang'];?>">Jual</a></td>
