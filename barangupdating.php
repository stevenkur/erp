  ...
  <div class="content-wrapper">
              ...
              for($i=0; $i<sizeof($hasil); $i++)
              {
                echo '
                  <tr>
                    ...
                    <td><a class="btn btn-primary" type="submit" href="<?php echo 'barangupdating.php?idbarang='.$result[$i]['idbarang'].'&namabarang='.$result[$i]['namabarang'].'&stockbarang='.$result[$i]['stockbarang']; ?>">Edit</a></td>
    ...
    <section class="col-lg-5">
      <div class="box box-primary">
        <!-- /.box-header -->
        <div class="box-body">
        <h3>Update Barang "<?php echo $_GET['namabarang'];?>"</h3>
        <form action="updatebarang.php" role="form" name="formbarang" method="post">
          <br>
          <div class="form-group">
            <label class="col-lg-2"> ID </label>
            <label class="col-lg-1">:</label>
            <input type="text" id="idbarang" name="idbarang" size="30" value="<?php echo $_GET['idbarang'];?>">
          </div>
          <div class="form-group">
